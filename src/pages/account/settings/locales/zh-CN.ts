export default {
  ...
  'account-settings.binding.alipay': '绑定账号',
  'account-settings.binding.alipay-description': '当前未绑定账号账号',
  ...
  'account-settings.notification.todo': '待办项目',
  'account-settings.notification.todo-description': '待办项目将以站内信的形式通知',
